...
net.write_json_to_file('viz', 'json/mult_view1.json', 'indent')
net.write_json_to_file('sim_row', 'json/mult_view_sim_row1.json', 'no-indent')
net.write_json_to_file('sim_col', 'json/mult_view_sim_col1.json', 'no-indent')
print("Files Written!")
